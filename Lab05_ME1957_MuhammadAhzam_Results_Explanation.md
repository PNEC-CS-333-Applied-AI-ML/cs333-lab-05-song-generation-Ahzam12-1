...
| File | Description |
|------|-------------|
| `Lab05_Music_Generation_ME1957_MuhammadAhzam.ipynb` | Main Jupyter notebook with all code, answers, and implementation |
| `Lab05_ME1957_MuhammadAhzam_OUTPUTS.zip` | Generated audio outputs and intermediate files |
| `Lab05_ME1957_MuhammadAhzam_Results_Explanation.md` | This file — explanation of the lab, methodology, and results |
